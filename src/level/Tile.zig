...
pub const Tile = struct {
    ...
    pub fn render(self: *Tile, t: *Tesselator, level: *Level, layer: i32, x: i32, y: i32, z: i32) void {
        const _u0: f32 = @as(f32, @floatFromInt(self.tex)) / 16.0;
        ...
        if (!level.isSolidTile(x, y, z - 1)) {
            ...
            if ((@intFromBool(br == c2) ^ @intFromBool(layer == 1)) != 0) {
                t.color(br, br, br);
                t.tex(_u1, v0);
                t.vertex(x0, y1, z0);
                t.tex(_u0, v0);
        ...
        if (!level.isSolidTile(x - 1, y, z)) {
            ...
            if ((@intFromBool(br == c3) ^ @intFromBool(layer == 1)) != 0) {
                t.color(br, br, br);
                t.tex(_u1, v0);
                t.vertex(x0, y1, z1);
                t.tex(_u0, v0);
...
pub var rock:  Tile = Tile{ .tex = 0 };
pub var grass: Tile = Tile{ .tex = 1 };